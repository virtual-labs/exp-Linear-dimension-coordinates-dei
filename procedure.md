...
1.	On the first page, four cases are provided to study linear independence of various subsets of <i>R</i><sup>2</sup>.<br>
2.	In each case, answer the question by clicking the appropriate button. It will display correctness of the answer together with the reason. <br>
3.	On the same page, in Example 1a and Example 1b, observe the geometry and press “Click here” button to see the answer and the reason for the given statement. <br>
...
9.	In second section, select the values of <i>x</i><sub>1</sub>, <i>y</i><sub>1</sub> to choose <i>b</i> and click on “Geometry” button to observe both the points a and b together on the graph. <br>
...
13.	In Step 3, hands on practice is also provided in the "Example" section. In this section, to choose a subset <i>B</i> of <i>R</i><sup>2</sup>, select the values <i>u, v</i>, <i>w</i> and <i>x</i> then click on “Submit” to check whether the chosen subset <i>B</i> is a basis or not.</span>
