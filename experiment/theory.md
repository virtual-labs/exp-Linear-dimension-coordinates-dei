...
<span style="font-family: 'Times New Roman'; font-size: 22px;">A non-empty subset <i>B</i> of <i>V</i> is said to be a basis if <i>B</i> is a linearly independent set and spans <i>V</i>.</span>
