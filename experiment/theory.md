...
<span style="font-family: 'Times New Roman'; font-size: 22px;">Let &straightphi;≠<i>S</i>⊆<i>V</i>. Then <i>S</i> is said to be a linearly independent set if it is not linearly dependent. Notice that the non-empty set &straightphi; is defined to be linearly independent.<br>
