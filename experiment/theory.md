This experiment aims to help students understand the key ideas in linear algebra, namely linear independence, basis, dimension, and coordinates. These concepts are essential while working with vector spaces. Students will learn how to determine whether vectors are linearly independent, how a basis can be formed and how to express any vector in terms of a chosen basis providing coordinates. Here <i>V</i> denotes a vector space over <i>R</i> or <i>C</i>.
